...
enum PEN_RENDER_HIGHLIGHT_METHOD {
  ...
  CLEAR_BOLD            =-0b00000001,
  CLEAR_ITALIC          =-0b00000010,
  CLEAR_UNDERSCORE      =-0b00000100,
  CLEAR_STRIKETHROUGH   =-0b00001000,
  CLEAR_INVERT          =-0b00010000,
  CLEAR_BOX             =-0b00100000,
  CLEAR_BLINK           =-0b01000000,
  CLEAR_BLOCK           =-0b10000000,
};
